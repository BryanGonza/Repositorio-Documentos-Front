...
import { RolesService } from '../../../services/roles.service'; // Importación agregada
...
export default class ActualizarPermisoComponent {
  ...
  private rolesService = inject(RolesService); // Servicio de roles
  listaRoles: any[] = []; // Lista de roles para el <select>

  permisoId: number = 0;
  idRol: number = 0;  // Este ahora se seleccionará desde el <select>
  idObjeto: number = 0;
